...
// Added in for testing, MingSi pls replace these methods.
bool PKBInterface::isNextStarComputed(STMT_NUM stmt) {
    return false;
}

void PKBInterface::addAllNextStarFrom(STMT_NUM toAddTo, STMT_NUM toAddFrom) {
    return;
}
