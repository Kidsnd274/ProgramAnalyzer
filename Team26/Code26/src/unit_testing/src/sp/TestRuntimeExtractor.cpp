...
TEST_CASE("Simple Next* test") {
    ...
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 1));
    rte.computeNextStar(createdCFG, 1);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 2));
    rte.computeNextStar(createdCFG, 2);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 3));
    rte.computeNextStar(createdCFG, 3);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 4));
    rte.computeNextStar(createdCFG, 4);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 5));
    rte.computeNextStar(createdCFG, 5);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 6));
    rte.computeNextStar(createdCFG, 6);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 7));
    rte.computeNextStar(createdCFG, 7);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 8));
    rte.computeNextStar(createdCFG, 8);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 9));
    rte.computeNextStar(createdCFG, 9);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 10));
    rte.computeNextStar(createdCFG, 10);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::NEXT_T, 11));
    rte.computeNextStar(createdCFG, 11);

    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 1));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 2));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 3));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 4));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 5));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 6));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 7));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 8));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 9));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 10));
    REQUIRE(pkbInterface->hasRelation(RelationType::NEXT_T, 11));
...
TEST_CASE("Simple affects test") {
    ...
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 1));
    rte.computeAffects(createdCFG, 1);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 2));
    rte.computeAffects(createdCFG, 2);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 4));
    rte.computeAffects(createdCFG, 4);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 5));
    rte.computeAffects(createdCFG, 5);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 7));
    rte.computeAffects(createdCFG, 7);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 8));
    rte.computeAffects(createdCFG, 8);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 9));
    rte.computeAffects(createdCFG, 9);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 10));
    rte.computeAffects(createdCFG, 10);

    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 1));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 2));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 4));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 5));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 7));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 8));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 9));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 10));
...
TEST_CASE("Simple affects Star test") {
    ...
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 1));
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS, 1));
    rte.computeAffectsStar(createdCFG, 1);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 2));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 2));
    rte.computeAffectsStar(createdCFG, 2);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 4));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 4));
    rte.computeAffectsStar(createdCFG, 4);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 5));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 5));
    rte.computeAffectsStar(createdCFG, 5);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 7));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 7));
    rte.computeAffectsStar(createdCFG, 7);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 8));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 8));
    rte.computeAffectsStar(createdCFG, 8);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 9));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 9));
    rte.computeAffectsStar(createdCFG, 9);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 10));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 10));
    rte.computeAffectsStar(createdCFG, 10);
    REQUIRE_FALSE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 11));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS, 11));
    ...
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 1));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 2));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 4));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 5));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 7));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 8));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 9));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 10));
    REQUIRE(pkbInterface->hasRelation(RelationType::AFFECTS_T, 11));
